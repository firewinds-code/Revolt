                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <form id="searchinputform">
                            <div class="form-group col-md-9">
                                ...
                                <div class="input-group col-md-10">
                                    <input type="text" class="form-control float-right" id="searchinput" placeholder="Enter Mobile,Ticket Number for search from Mobile Number,Ticket Number" required autocomplete="off">
                                    <div class="col-md-2">
                                        <button type="Submit" id="searchsubmit" class="btn btn-block btn-primary"><i class="fa fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="form-group col-md-2" style="margin-left: 410px;">
                            <button type="button" id="new_ticket_button" class="btn btn-block btn-primary">New Ticket</button>
                        </div>
                        <div class="form-group col-md-12" style=" padding: 25px 20px 5px 20px; display:none;" id="ticket_form">
                            <form method="POST" action="{{ route('ticketsubmit') }}" enctype="multipart/form-data" name="firstform" id="firstform" data-parsley-validate>
                                @csrf
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label>Ticket Number</label>
                                            <input type="text" class="form-control" readonly name="ticket_no" id="ticket_no">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Customer Name" name="customer_name" id="customer_name">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control @error('mobile_number') is-invalid @enderror" placeholder="Enter Mobile Number" name="mobile_number" id="mobile_number">
                                            @error('mobile_number')
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control @error('email_id') is-invalid @enderror" placeholder="Enter Email ID" name="email_id" id="email_id">
                                            @error('email_id')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('contact_reason_sub') is-invalid @enderror" id="contact_reason_sub" name="contact_reason_sub">
                                                <option value="" id="contact_reason_sub_option"> Select Contact Reason Type</option>
                                            </select>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('contact_reason_sub_sub') is-invalid @enderror" id="contact_reason_sub_sub" name="contact_reason_sub_sub">
                                                <option value="" id="contact_reason_sub_sub_option"> Select Contact Reason Type</option>
                                            </select>
                                    ...
                                    <div class="col-sm-4" style="display: none;" id="app_product_issue">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('product_issue') is-invalid @enderror" name="app_product_issue" id="app_product_issue">
                                                <option value=""> Select Product issue</option>
                                                <option value="Resource not Found">Resource not Found</option>
                                                <option value="GPS signal not available"> GPS signal not available</option>
                                    ...
                                    <div class="col-sm-4" style="display: none;" id="issue_div">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('booking_id') is-invalid @enderror" placeholder="Enter Booking ID" id="booking_id" name="booking_id">
                                            @error('booking_id')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Chasis Number" id="chasis_number" name="chasis_number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" data-target-input="nearest">
                                                <input type="text" class="form-control datetimepicker-input" id="purchase_date" name="purchase_date" data-target="#purchase_date" />
                                    ...
                                    <div class="col-sm-3">
									   ...
									   <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" readonly placeholder="Enter Location Code" id="location_code" name="location_code">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('call_status') is-invalid @enderror" name="call_status" id="call_status">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('ResolutionProvided') is-invalid @enderror" name="ResolutionProvided" id="ResolutionProvided"></textarea>
                        ...
                        <div class="form-group col-md-12" style=" padding: 25px 20px 5px 20px; display:none;" id="table_old_new">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (val in response['0']) {
                    var newOption = $('<option value="' + response['0'][val]['interaction_type'] + '">' + response['0'][val]['interaction_type'] + '</option>');
                ...
                for (val in response['2']) {
                    var newOption = $('<option value="' + response['2'][val]['city'] + '">' + response['2'][val]['city'] + '</option>');
                    $('#city').append(newOption);
                }
                for (val in response['3']) {
                    var newOption = $('<option value="' + response['3'][val]['dealership'] + '">' + response['3'][val]['dealership'] + '</option>');
